...
data_path = os.path.join(script_dir, '..', '..', 'data','base_data', 'merged_cleaned.csv')
data_path = os.path.abspath(data_path)
...
data = data.drop(columns=['avg_weight', 'total_weight', 'num_anim_total', 't2m_C'])
...
# Export the model
model_path = os.path.join(script_dir, '..', '..', 'data','models', 'test-knn_water_model.joblib')
